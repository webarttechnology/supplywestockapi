...
const createOrder = async (req, res) => {
    ...
    try{
        ...
        const message = `<div class='isResiver'><p>order has been generated by : ${sellerDetails.userCode}</p><strong class='headingPd'>Product Details</strong><ul class='proDetails'><li><strong>Product name :</strong>${body.productName}</li><li><strong>Amount : </strong>${finalAmount}</li><li><strong>Quantities : </strong> ${body.quantities}</li></ul></div>`
